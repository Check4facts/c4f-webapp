...
import { getSearchEntities, getEntities } from './topic.reducer';
...
export const Topic = (props: ITopicProps) => {
  ...
  return (
    <div>
      <h2 id="topic-heading">
        <Translate contentKey="check4FactsApp.topic.home.title">Topics</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="check4FactsApp.topic.home.createLabel">Create new Topic</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('check4FactsApp.topic.home.search')}
                />
        ...
        {topicList && topicList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="check4FactsApp.topic.home.notFound">No Topics found</Translate>
            </div>
          )
        )}
      </div>
