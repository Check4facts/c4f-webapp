  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="check4FactsApp.category.home.createOrEditLabel">
            <Translate contentKey="check4FactsApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="category-name">
                  <Translate contentKey="check4FactsApp.category.name">Name</Translate>
                </Label>
                <AvField
                  id="category-name"
                  type="text"
