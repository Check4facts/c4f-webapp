...
export const News = (props: INewsProps) => {
  ...
  return (
    <div>
      <h2 id="news-heading">
        <Translate contentKey="check4FactsApp.news.home.title">News</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="check4FactsApp.news.home.createLabel">Create new News</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="check4FactsApp.news.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="check4FactsApp.news.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('content')}>
                  <Translate contentKey="check4FactsApp.news.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {newsList.map((news, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{news.title}</td>
                  <td>{news.date ? <TextFormat type="date" value={news.date} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{news.content}</td>
