...
import { Tooltip, Table, Row, Col, Label, Button, Container } from 'reactstrap';
            ...
            <AvForm model={{}} onSubmit={saveStatement}>
              ...
              <Col md={{ size: 8, offset: 2 }} style={{ borderBottom: '1px solid rgba(0,0,0,0.2)', paddingBottom: '1.5rem' }}>
                ...
                <AvGroup>
                  ...
                  <div style={{ columnGap: 20, alignItems: 'center', display: 'flex' }}>
                    <div style={{ flex: 1 }}>
                      <AvInput
                        id="statement-topic"
                        type="select"
                        ...
                        name="topic.id"
                        required
                        value={topics && !selectedTopic && topics[0] ? topics[0].id : selectedTopic}
                ...
                <Col md={{ size: 8, offset: 2 }} className="text-center">
                  ...
                  <AvForm model={{}} beforeSubmitValidation={beforeAdd} onSubmit={addSubTopic} ref={subTopicsFormRef}>
                    <AvGroup>
                      <AvInput id="sub-topic-text" type="text" name="text" />
                    </AvGroup>
              ...
              <Col md={{ size: 8, offset: 2 }} style={{ paddingTop: '1.5rem' }}>
                ...
                <AvForm model={{}} beforeSubmitValidation={beforeAdd} onSubmit={addStatementSource} ref={statementSourceFormRef}>
                  <AvGroup>
