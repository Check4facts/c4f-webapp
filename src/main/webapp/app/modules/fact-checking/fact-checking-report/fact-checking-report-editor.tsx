import 'app/entities/article/article-content-editor.scss'
...
export const FactCheckingReportEditor = (props: IArticleContentEditorProps) => {
...
export default FactCheckingReportEditor;
