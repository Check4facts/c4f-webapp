              ...
              <div style={{ maxWidth: 1000 }}>
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <p>
                      <strong>Ioannis Emiris</strong>, President and General Director of the Athena Research Center, Professor, Department
                      of Informatics and Telecommunications, National and Kapodistrian University of Athens.
                    </p>
                  </li>
                  <br />
                  <li>
                ...
                <p>
                  Απόστολος Λιναρδής, Ερευνητής Βαθμίδας Α, Εθνικό Κέντρο Κοινωνικών Ερευνών- Σταμάτης Πουλακιδάκος, Επίκουρος Καθηγητής,
                  Τμήμα Επικοινωνίας και Ψηφιακών Μέσων, Πανεπιστήμιο Δυτικής Μακεδονίας,
                </p>
                <p>
                  <strong>
                ...
                <p>
                  Stamatis Poulakidakos, Assistant Professor, Department of Communication and Digital Media, University of Western Macedonia
                </p>
                <p>
                  <div id="ft2">
                    <strong>
                ...
                <p>
                  George Koutalieris, Research and Innovation Engineer, SocialTruth Project Coordination Team, Institute of Communication
                ...
                <br />
                <p>
                  Νίκος Δεμερτζής, Διευθυντής και Πρόεδρος του ΔΣ του Εθνικού Κέντρου Κοινωνικών Ερευνών, Καθηγητής Τμήματος Επικοινωνίας
                ...
                <p>
                  Nicolas Demertzis, Director of EKKE and President of the Board of Administrators, Professor, Department of Communication
                ...
                <br />
                <p>
                  <strong>Γιώργος Πλειός</strong>, Μέλος Εθνικού Συμβουλίου Ραδιοτηλεόρασης, Καθηγητής, Τμήμα Επικοινωνίας και ΜΜΕ, Εθνικό
                ...
                <div>
                  ...
                  <div id="ftn1">
                    <p>
                      ...
                      Η ημερίδα θα είναι υβριδική και η παρακολούθησή της θα μπορεί να γίνει είτε δια ζώσης είτε διαδικτυακά στο σύνδεσμο
                      που αναφέρεται κάτω από τον τίτλο. Θα δοθούν βεβαιώσεις παρακολούθησης σε όσες/όσους επιθυμούν και μας δώσουν τα
                      στοιχεία τους (ονοματεπώνυμο, e-mail), είτε στο διαδικτυακό σύνδεσμο, είτε δια ζώσης την ημέρα του συνεδρίου. The
                      one-day conference will be hybrid, and anyone will be able to attend it either online or in person. Certificates of
                      attendance will be given to those who give us their details (name, e-mail), either online or in-person on the day of
                      the conference.
                    </p>
                  </div>
                  <div id="ftn2">
                    <p>
                      ...
                      ημερίδας για υπάρχει και διερμηνεία. Presentations whose titles are written in both Greek and English will be
                      conducted in Greek. Presentations whose titles are written only in English, will be conducted in English. During the
                      one-day conference there will be interpretation available.
                    </p>
                  </div>
                </div>
              </div>
