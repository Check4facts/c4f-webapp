  ...
  const projectItems = [
    ...
    },
    {
      ...
      content: <div className="text-left">
        ...
        <ul>
          <li><p>Καθηγητή Νίκο Δεμερτζή, Επιστημονικό Υπεύθυνο, Καθηγητή του Τμήματος Επικοινωνίας και ΜΜΕ του Πανεπιστημίου Αθηνών</p></li>
          <li><p>Καθηγητή Γιώργο Πλειό του Τμήματος Επικοινωνίας και ΜΜΕ του Πανεπιστημίου Αθηνών</p></li>
          ...
          <li><p>Δρ. Μιχαήλ Ταστσόγλου, Διδάσκων του Τμήματος Επικοινωνίας και ΜΜΕ του Πανεπιστημίου Αθηνών</p></li>
          ...
          <li><p>Εύα Τομαρά, σύμβουλο επικοινωνίας στους ευρωπαϊκούς θεσμούς και συνεργάτιδα ερευνήτρια του Εθνικού Κέντρου Κοινωνικών Ερευνών.</p></li>
          <li><p>Νάντια Βασιλειάδου, δημοσιογράφο και συνεργάτιδα ερευνήτρια του Εθνικού Κέντρου Κοινωνικών Ερευνών.</p></li>
        </ul>
    ...
    },
    {
      ...
      content: <div className="text-left">
        <ul>
          <li>
            <p className='font-weight-bold'>2019-2022</p>
            <p>Το έργο χρηματοδοτήθηκε από το <a href="http://www.elidek.gr/en/homepage/">Ελληνικό Ίδρυμα Έρευνας και
            Καινοτομίας</a> (grant agreement HFRI-FM17-2283),
            για τον έλεγχο της αξιοπιστίας πολιτικών δηλώσεων γύρω από την
            εγκληματικότητα/παραβατικότητα και το μεταναστευτικό/προσφυγικό ζήτημα. Με
            την προσθήκη του ελέγχου αξιοπιστίας ειδήσεων γύρω από την κλιματική
            κρίση/περιβάλλον και την υγεία/πανδημία.
            </p>
          </li>
          <li>
            <p className='font-weight-bold'>2022-2023</p>
            <p>Το έργο χρηματοδoτήθηκε με ιδίους πόρους από τη σύμπραξη οκτώ ερευνητικών και πανεπιστημιακών
            φορέων.
            </p>
          </li>
          <li>
        ...
        {/* <p>Αρχικά το έργο χρηματοδοτήθηκε από το <a href="http://www.elidek.gr/en/homepage/">Ελληνικό Ίδρυμα Έρευνας και
          Καινοτομίας</a> (grant agreement HFRI-FM17-2283) για την περίοδο 2019-2022,
          για τον έλεγχο της αξιοπιστίας πολιτικών δηλώσεων γύρω από την
          εγκληματικότητα/παραβατικότητα και το μεταναστευτικό/προσφυγικό ζήτημα. Με
          την προσθήκη του ελέγχου αξιοπιστίας ειδήσεων γύρω από την κλιματική
          κρίση/περιβάλλον και την υγεία/πανδημία. Από το 2023 το έργο
          χρηματοδοτείται από τη σύμπραξη οκτώ ερευνητικών και πανεπιστημιακών
          φορέων, αφενός, και από το πρόγραμμα <a href="https://climpact.gr/main/">CLIMPACT II</a>, αφετέρου.
        </p> */}
      </div>
    },
    {
    ...
    },
    {
      ...
      content: <div className="text-left">
        ...
        <div className="mt-4"><img src="../../content/images/eketa-logo-small.png" alt="eketa logo" height="60"/>
