...
import gr.ekke.check4facts.config.audit.AuditEventConverter;
import gr.ekke.check4facts.domain.PersistentAuditEvent;
...
import static gr.ekke.check4facts.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
