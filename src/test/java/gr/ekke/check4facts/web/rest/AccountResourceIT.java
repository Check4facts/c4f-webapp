...
import gr.ekke.check4facts.config.Constants;
import gr.ekke.check4facts.domain.User;
import gr.ekke.check4facts.repository.AuthorityRepository;
import gr.ekke.check4facts.repository.UserRepository;
import gr.ekke.check4facts.security.AuthoritiesConstants;
import gr.ekke.check4facts.service.UserService;
import gr.ekke.check4facts.service.dto.PasswordChangeDTO;
import gr.ekke.check4facts.service.dto.UserDTO;
import gr.ekke.check4facts.web.rest.vm.KeyAndPasswordVM;
import gr.ekke.check4facts.web.rest.vm.ManagedUserVM;
...
import static gr.ekke.check4facts.web.rest.AccountResourceIT.TEST_USER_LOGIN;
